...
namespace TheVagabondsDirectiveToTheUniverse
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Well heres the gist of it {playerName}, \n" +
                ...
                $"in need of some... extra-curricular fun, which is strongly reccomended against in chapter\n" +
                $"four section eleven of the directive! Oh lord you probably don't even remember that. Do you remember???|n" +
